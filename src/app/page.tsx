  ...
  return (
    <Table className="border">
      ...
      <TableBody>
          ...
          <TableCell className={cn('text-right', {'font bold text-green-400': goals1 > goals2})}>{goals1}</TableCell>
          <TableCell className={cn('text-right', {'font bold text-green-400': goals2 > goals1})}>{goals2}</TableCell>
        </TableRow>
        ))}
      </TableBody>
    </Table>
